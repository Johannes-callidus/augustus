...
typedef enum {
    ...
    TR_EDITOR_TOOL_OUTSKIRTS,
    TR_EDITOR_TOOL_OUTSKIRTS_REMOVE,
    TR_EDITOR_SELECT_LAND,
    ...
    TR_EDITOR_SELECT_OFFSET,
    TR_WARNING_NO_MILITARY_ON_OUTSKIRTS,
    TR_CONFIG_SHOW_OUTSKIRTS_DESIRABILITY,
